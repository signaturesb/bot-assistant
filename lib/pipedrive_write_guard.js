...
const EXPLICIT_WRITE_RE = /(?:^|\s)\/lead\b|\b(cr[eé]e|cr[eé]er|ajoute|ajouter|enregistre|enregistrer|modifie|modifier|change|changer|d[eé]place|d[eé]placer|fusionne|fusionner|supprime|supprimer|efface|effacer|mets?-?moi|planifie|planifier)\b/i;
const PIPEDRIVE_CONTEXT_RE = /\b(leads?|deals?|prospects?|clients?|pipedrive|notes?|activites?|taches?|rappels?|suivis?|visites?)\b/i;
