...
const TOOLS = [
  ...
  { name: 'chercher_listing_dropbox', description: 'Chercher un dossier listing/terrain dans Dropbox par nom de ville, adresse ou numéro Centris. Retourne les PDFs et photos disponibles.', input_schema: { type: 'object', properties: { terme: { type: 'string', description: 'Nom de ville, adresse partielle ou numéro Centris' } }, required: ['terme'] } },
  { name: 'envoyer_docs_prospect',   description: 'Trouver les documents Dropbox d\'un listing et les envoyer par email à un prospect. Cherche automatiquement par Centris ou nom.', input_schema: { type: 'object', properties: { terme: { type: 'string', description: 'Nom du prospect dans Pipedrive' }, email: { type: 'string', description: 'Email destination (optionnel si dans Pipedrive)' }, fichier: { type: 'string', description: 'Nom partiel du fichier PDF (optionnel — premier PDF sinon)' } }, required: ['terme'] } },
  // ── Diagnostics ──
